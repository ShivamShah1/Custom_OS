...
#include "status.h"
/*
    To check the wheter the format of the path received is valid or not
*/
...
/*
    create the path relative from root 
*/
...
/*
    get the part of the path for easy access
*/
...
/*
    To create a func that will create the path struct elements
*/
